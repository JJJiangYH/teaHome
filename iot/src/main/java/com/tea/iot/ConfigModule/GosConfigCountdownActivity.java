package com.tea.iot.ConfigModule;
...
import com.tea.iot.view.RoundProgressBar;
...
public class GosConfigCountdownActivity extends GosConfigModuleBaseActivity {
    ...
    private void readyToSoftAP() {
        ...
        WifiAutoConnectManager.WifiCipherType cipherType = WifiAutoConnectManager.getCipherType(GosConfigCountdownActivity.this, softSSID);
