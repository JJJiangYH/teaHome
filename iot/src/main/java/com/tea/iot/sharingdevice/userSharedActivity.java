    ...
    protected void onResume() {
        ...
        GizDeviceSharing.setListener(new GizDeviceSharingListener() {
            ...
            public void didSharingDevice(GizWifiErrorCode result, String deviceID, int sharingID,
                ...
                if (result.ordinal() == 0) {
                    Toast.makeText(userSharedActivity.this, getResources().getString(R.string.alawyssend), Toast.LENGTH_LONG).show();
                    finish();
                } else {
                    Toast.makeText(userSharedActivity.this, getResources().getString(R.string.send_failed1), Toast.LENGTH_LONG).show();
