    ...
    protected void onResume() {
        ...
        GizDeviceSharing.setListener(new GizDeviceSharingListener() {
            ...
            public void didAcceptDeviceSharingByQRCode(GizWifiErrorCode result) {
                ...
                if (result.ordinal() == 0) {
                    Toast.makeText(gosZxingDeviceSharingActivity.this, "success", Toast.LENGTH_LONG).show();

                    finish();
                } else {
                    Toast.makeText(gosZxingDeviceSharingActivity.this, toastError(result), Toast.LENGTH_LONG).show();
            ...
            public void didCheckDeviceSharingInfoByQRCode(GizWifiErrorCode result, String userName, String productName,
                ...
                if (8041 <= errorcode && errorcode <= 8050 || errorcode == 8308) {
                    ...
                    Toast.makeText(gosZxingDeviceSharingActivity.this,
                            diff % 60 + "", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
