    ...
    class myadapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (!TextUtils.isEmpty(uid) && !uid.equals("null")) {
                String myuid = uid.substring(0, 3) + "***" + uid.substring(uid.length() - 4);
            ...
            delete2name.setOnClickListener(arg0 -> quitAlert(getActivity(), tvDeviceName.getText().toString(), GosConstant.mybindUsers.get(position).getUid()));
