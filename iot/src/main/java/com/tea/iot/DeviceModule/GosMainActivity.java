...
import com.tea.iot.CommonModule.NoScrollViewPager;
...
import com.tea.iot.sharingdevice.messageCenterActivity;
...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == android.R.id.home) {// activity.logoutToClean();
            ...
            if (!checkNetwork(GosMainActivity.this)) {
                Toast.makeText(GosMainActivity.this, R.string.network_error, LENGTH_LONG
                ).show();
            } else {
    ...
    public void exitBy2Click() {
        ...
        if (!isExit) {
            ...
            Toast.makeText(this, doubleClick, LENGTH_LONG).show();
            tExit = new Timer();
