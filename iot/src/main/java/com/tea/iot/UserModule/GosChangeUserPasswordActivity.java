        ...
        public void didChangeUserPassword(
            ...
            if (result.getResult() == 0) {
                Toast.makeText(GosChangeUserPasswordActivity.this,
                        getResources().getString(R.string.passsuccess), Toast.LENGTH_LONG)
                        .show();
                finish();
                ...
                if (result.getResult() == 9020) {
                    ...
                    Toast.makeText(GosChangeUserPasswordActivity.this,
                            getResources().getString(R.string.passerror), Toast.LENGTH_LONG)
                            .show();
                }
    ...
    public void confirm(View v) {
        ...
        if (TextUtils.isEmpty(oldpass.getText().toString())
            ...
            if (TextUtils.isEmpty(oldpass.getText().toString())) {
                ...
                Toast.makeText(
                        ...
                        getResources().getString(
                                R.string.enter_current_password), Toast.LENGTH_LONG).show();
            ...
            if (npass.equals(cpass)) {
                ...
                Toast.makeText(this,
                        getResources().getString(R.string.nosamepass), Toast.LENGTH_LONG)
                        .show();
            }
        }
    }
